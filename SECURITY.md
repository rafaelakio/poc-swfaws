...
1. **Reporte Privadamente**
   - Use o recurso de [Security Advisories](https://github.com/rafaelakio/poc-swfaws/security/advisories/new) do GitHub
...
- **GitHub Security**: [Security Advisories](https://github.com/rafaelakio/poc-swfaws/security/advisories)

Para outras questões:
- **Issues**: [GitHub Issues](https://github.com/rafaelakio/poc-swfaws/issues)
